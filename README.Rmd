...
Both the bootstrapper and sampler objects can be used for repeated reproducible sampling. 
...
The new stat `stat_confidence_density()` can be used to generate confidence strips.
