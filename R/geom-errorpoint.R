#' @usage NULL
# @export
geom_errorpoint <- function(mapping = NULL, data = NULL,
...
#' @rdname geom_errorpoint
#' @usage NULL
# @export
GeomErrorpoint <- ggproto("GeomErrorpoint", Geom,
  default_aes = aes(
    colour = "black", size = 0.5, linetype = 1, width = 0.5, alpha = NA),
